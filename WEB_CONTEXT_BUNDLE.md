...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-opg-382-aharoni-berger-conjecture-645898b6-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/OPG-382"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-opg-382-aharoni-berger-conjecture-645898b6-v1",
      "problem_contract_sha256": "069409f756deda46b80b2475289f519b93e87d33482f83355338cbfee6e58d0a",
      "problem_id": "problem:um-opg-382-aharoni-berger-conjecture-645898b6",
      "route_id": "route:um-opg-382-aharoni-berger-conjecture-645898b6-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-opg-382-aharoni-berger-conjecture-645898b6-source-fidelity-01",
      "graph_id": "graph:um-opg-382-aharoni-berger-conjecture-645898b6-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-opg-382-aharoni-berger-conjecture-645898b6-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-opg-382-aharoni-berger-conjecture-645898b6-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Conjecture If $M_1,\\ldots,M_k$ are matroids on $E$ and $\\sum_{i=1}^k rk_{M_i}(X_i) \\ge \\ell (k-1)$ for every partition $\\{X_1,\\ldots,X_k\\}$ of $E$, then there exists $X \\subseteq E$ with $|X| = \\ell$ which is independent in every $M_i$."
          },
          "statement_sha256": "ba32b7b14a313a352e96b2ea6683ea3d2ec959e4cbce1769bd6c2846b590c3a0"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-opg-382-aharoni-berger-conjecture-645898b6-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-opg-382-aharoni-berger-conjecture-645898b6-root",
      "route_id": "route:um-opg-382-aharoni-berger-conjecture-645898b6-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-opg-382-62c2b6f1f01c",
        "url": "https://www.unsolvedmath.com/problems/OPG-382"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
